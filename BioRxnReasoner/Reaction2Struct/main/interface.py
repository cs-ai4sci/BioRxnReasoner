...
try:
    ...
    ChemRxnExtractor = None
    
from .tableextractor import TableExtractor
from .utils import *

class  Reaction2Struct:
...
if __name__=="__main__":
    model =  Reaction2Struct()
    # images = [Image.open("path_to_image1.jpg"), Image.open("path_to_image2.jpg")]
    ...
    # # 打印结果
    # print("Molecule Results:", molecule_results)
